...
public class Pedometer extends Activity implements AdListener{
	...
	String Adwo_PID = "13ca82457f8048fd83180b60e8f6febf";
...
//		当不设置广告条充满屏幕宽时建议放置在父容器中间
		...
		// 实例化广告对象
		adView = new AdwoAdView(Pedometer.this, Adwo_PID,false, 20);
		adView.setListener(Pedometer.this);
		// 把广告条加入界面布局
